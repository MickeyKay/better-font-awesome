...
The temporary Composer dependency is `dev-master#7bd53f548fe5028e0f60a35c6b457c05356ec811`, the BFAL PR #52 merge commit. The merge and final PR head `9b8fc57a1339204d281e99f233f463d6c3cbd118` both have tree `86fb39e848baff1cc449e9bb86d5380e8a9d2bbd`, verified through GitHub commit records. This implementation supplies the corrected `get_asset_delivery()` contract; BFA no longer inspects delivery/channel errors to compensate for the older accessor. See the [release procedure](release-procedure.md) for the stable dependency and strict Composer validation gates.
