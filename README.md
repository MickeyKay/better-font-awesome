...
## Screenshots ##
![The Better Font Awesome settings page](https://ps.w.org/better-font-awesome/assets/screenshot-1.png?raw=true)  
_The Better Font Awesome settings page_

---

![The icon shortcode dropdown selector](https://ps.w.org/better-font-awesome/assets/screenshot-2.png?raw=true)  
