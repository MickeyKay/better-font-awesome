...
## Screenshots ##
![The Better Font Awesome settings page](https://github.com/MickeyKay/better-font-awesome/raw/assets/screenshot-1.gif?raw=true)  
_The Better Font Awesome settings page_

---

![The icon shortcode dropdown selector](https://github.com/MickeyKay/better-font-awesome/raw/assets/screenshot-2.png?raw=true)  
