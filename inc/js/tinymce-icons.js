(function() {
	...
	var ICONS;
	var stylesheet_url = bfa_vars.stylesheet_url;

	jQuery.get(stylesheet_url, function (data) {
		//alert(data);
	});

	var icon_i = function(id) {
		return '<i class="fa icon-' + id + ' fa-' + id + '"></i>';
	}

	var icon_shortcode = function(id) {
		return '[icon name="fa icon-' + id + ' fa-' + id + '" class=""]';
	}
